	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				...
				'heading-1': ['2.75rem', { lineHeight: '1.2', letterSpacing: '-0.01em', fontWeight: '700' }],
				'heading-2': ['2.25rem', { lineHeight: '1.25', letterSpacing: '-0.01em', fontWeight: '700' }],
				'heading-3': ['1.75rem', { lineHeight: '1.3', letterSpacing: '0', fontWeight: '600' }],
				'heading-4': ['1.5rem', { lineHeight: '1.35', letterSpacing: '0', fontWeight: '600' }],
