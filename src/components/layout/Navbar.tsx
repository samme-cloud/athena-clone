    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <a 
            href="#hero" 
            className="font-serif text-2xl font-bold text-black group"
            onClick={(e) => {
              e.preventDefault();
              handleNavLinkClick('hero');
            }}
          >
            Athena<span className="text-mint-500 transition-all group-hover:text-mint-600">.</span>
            <span className="block h-0.5 w-0 bg-mint-500 transition-all duration-300 group-hover:w-full"></span>
          </a>
              ...
              <li key={link.id}>
                <a
                  ...
                  className={`relative px-1 py-2 font-medium transition-colors duration-300 ${
                    activeLink === link.id
                      ? 'text-mint-700'
                      : 'text-black hover:text-mint-600'
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
                ...
                >
                  {link.label}
                  <span 
                    className={`absolute left-0 bottom-0 w-full h-0.5 bg-mint-500 transform origin-bottom transition-transform duration-300 ${
          ...
          <Button 
            variant="default" 
            className="hidden md:flex bg-mint-600 hover:bg-mint-700 text-white relative overflow-hidden group"
            asChild
          >
            <a 
              href="#get-started"
        ...
        >
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-md p-6 mt-2">
